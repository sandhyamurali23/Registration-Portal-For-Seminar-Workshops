		...
		<div class="container">
           ...
           <center> <header class="clearfix">
               ...
               font-family: 'Gloria Hallelujah', cursive;}
				...
				<h1>Student Login <br>Welcome</h1>
                </header>
			</center>
...
$result = mysqli_query($con,"SELECT * FROM seminar where log='S'");
...
<br><br>			
<form><center>
<input type="button" value="Request a seminar/Workshop" onclick="window.location.href='http://www.hyperlinkcode.com/button-links.php'" />
</form> </center>
